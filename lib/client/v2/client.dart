...
class ConcertoV2Client {
  ...
  ConcertoV2Client({@required this.httpClient, @required this.baseURL});

  Future<Screen> getScreen({@required int screenId}) async {
  ...
  Future<List<Content>> getContent({@required String fieldContentPath}) async {
